...
--join amis am on am.id_personne1 = p.id_personne and am.id_personne2 = p.id_personne
...
insert into Amis values('2', '1', date('now', '+4 day'));
insert into Amis values('2', '3', date('now', '+5 day'));
insert into Amis values('2', '4', date('now', '+6 day'));

insert into Amis values('3', '1', date('now', '+6 day'));
insert into Amis values('3', '2', date('now', '+4 day'));
insert into Amis values('3', '4', date('now', '+2 day'));
insert into Amis values('3', '5', date('now', '+3 day'));

insert into Amis values('4', '1', date('now', '+2 day'));
insert into Amis values('4', '2', date('now', '+2 day'));
insert into Amis values('4', '3', date('now', '+3 day'));
